...
?>
    ...
    <main class="services-page style-5">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/1.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/2.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                                        Coupon Management
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/3.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/4.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 mb-lg-0 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/5.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 mb-lg-0 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/6.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card mb-30 mb-lg-0 style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/7.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <a href="#" class="features-card style-5">
                                <div class="icon">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/features/8.png" alt="">
                                </div>
                                <div class="info">
                                    <h5 class="card-title">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/16.png" alt="">
                                    </div>
                                    <div class="info">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/15.png" alt="">
                                    </div>
                                    <div class="info">
                                        <h5>Google/FB Ads</h5>
                                        <div class="text">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/14.png" alt="">
                                    </div>
                                    <div class="info">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/17.png" alt="">
                                    </div>
                                    <div class="info">
                                        <h5>Social Media</h5>
                                        <div class="text">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/18.png" alt="">
                                    </div>
                                    <div class="info">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/19.png" alt="">
                                    </div>
                                    <div class="info">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="service-card style-6">
                                    <div class="icon">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/serv_icons/20.png" alt="">
                                    </div>
                                    <div class="info">
                                        <h5>PPC Ads</h5>
                                        <div class="text">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-8 order-0 order-lg-2">
                            <div class="img main-img1">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_1_1.png" alt="" class="sm-circle">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_1_2.png" alt="" class="img-body">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_1_3.png" alt="" class="card1">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_1_4.png" alt="" class="card2">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_1_5.png" alt="" class="lg-circle">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <div class="img main-img2">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_2_1.png" alt="">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_2_2.png" alt="" class="img-body">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="section-head mb-30 style-5">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-4 order-2 order-lg-0">
                            ...
                            <p>
                                Dashboards are meant to be personal tools for website managers and suppliers to enjoy,
                                and are therefore largely modifiable.
                            </p>
                            <p class="mt-20">
                                When it comes to customer actions, website administrators can choose the permissions of
                                each supplier, allowing them to limit or empower commerce activity as needed.
                            </p>
                            <div class="d-flex align-items-center mt-70">
                                <div class="img me-2 flex-shrink-0">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/about/owners.png" alt="">
                                </div>
                                <div class="inf">
                                    <h4 class="color-blue5 mb-0 lh-1">42,500+</h4>
                        ...
                        <div class="col-lg-8 order-0 order-lg-2">
                            <div class="img main-img3">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_3_1.png" alt="" class="img-body">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_3_2.png" alt="">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_3_3.png" alt="">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_3_4.png" alt="">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/about_s5_3_5.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="testi-card style-5">
                                    ...
                                    <div class="user mt-40 text-center">
                                        <div class="icon-80 rounded-circle img-cover overflow-hidden m-auto">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/team/4.jpg" alt="">
                                        </div>
                                        <h6> Lucas Digne </h6>
        ...
        <!-- ====== start pricing ====== -->
        <section class="pricing section-padding border-bottom border-1 brd-gray style-5">
            <div class="container">
                <div class="section-head text-center mb-60 style-5">
                    <h2 class="mb-20"> Choose Plan and <span> Kick-start </span> </h2>
                    <p>
                        Whether you’re just getting started with rapid testing or scaling across the organization, we’ve
                        got you covered.
                    </p>
                </div>
                    ...
                    <div class="content">
                        <div class="price-head">
                            <div class="price-headTitle">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/price_s5.png" alt="">
                            </div>
                            <div class="price-headItem">
                                <h6>basic</h6>
                                <h2 class="monthly_price">Free <span>/mo</span></h2>
                                <h2 class="yearly_price">Free <span>/yr</span></h2>
                                <small>Free forever.!</small>
                                <small>No credit card required.</small>
                            </div>
                            <div class="price-headItem bg-gray5">
                                <h6>Premium</h6>
                                <h2 class="monthly_price color-blue5">$49 <span>/mo</span></h2>
                                <h2 class="yearly_price color-blue5">$49 <span>/yr</span></h2>
                                <small>Free forever.!</small>
                                <small>No credit card required.</small>
                                <div class="label">
                                    best choice
                            ...
                            <div class="price-headItem">
                                <h6>ultimate</h6>
                                <h2 class="monthly_price">$99 <span>/mo</span></h2>
                                <h2 class="yearly_price">$99 <span>/yr</span></h2>
                                <small>Free forever.!</small>
                                <small>No credit card required.</small>
                            </div>
                        </div>
                        ...
                        <div class="price-body">
                            ...
                            <div class="price-bodyItems">
                                <div class="price-bodyTitle">
                                    Free Google Analysis <i class="fas fa-info-circle"></i>
                                </div>
                                <div class="price-item">
                                    <span>$5/Year</span>
                                </div>
                            ...
                            <div class="price-bodyItems">
                                <div class="price-bodyTitle">
                                    Auto Lifetime Upgrade <i class="fas fa-info-circle"></i>
                                </div>
                                <div class="price-item">
                                </div>
                                <div class="price-item bg-gray5">
                            ...
                            <div class="price-bodyItems">
                                <div class="price-bodyTitle">
                                    Free SSL Certificate <i class="fas fa-info-circle"></i>
                                </div>
                                <div class="price-item">
                                </div>
                                <div class="price-item bg-gray5">
