                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="jop-info">
                                ...
                                <div class="text d-flex mb-20">
                                    ...
                                    <p> We are real state developer company at Egypt, Cairo looking for expert and
                                        skilled person who edit, retouch, manipulate photo in Adobe Photoshop in
                                        professional way. </p>
                                </div>
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                                            class="fas fa-check-circle"></i> </span>
                                    <p> If you are working in such kind of job in any Printing Press, Printing and
                                        Publishing Media and you are really skilled in Photoshop then you are highly
                                ...
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                                            class="fas fa-check-circle"></i> </span>
                                    <p> Develop and design design logo, leaflet, banner, brand identity packages, flyer,
                                        book, poster, paper ad, bill board, corporate profile, greeting cards, visiting
                                        cards etc. </p>
                                </div>
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                                    ...
                                    <p> <strong class="color-000"> Work on: </strong> clipping path, multi path, various
                                        ...
                                        Correction, Dust/srcatch removal, Background Removal, Neck joint/3D Ghost
                                ...
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                                            class="fas fa-check-circle"></i> </span>
                                    <p> Bachelor of Fine Arts (B.F.A), Diploma in Architecture, Bachelor degree in any
                                        discipline </p>
                                </div>
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                                ...
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                                            class="fas fa-check-circle"></i> </span>
                                    <p> The applicants should have experience in the following area(s): Template Making,
                                        Troubleshooting. </p>
                                </div>
                                <div class="text d-flex mb-20">
                                    <span class="icon color-blue5 me-2 flex-shrink-0"> <i
                        ...
                        <div class="col-lg-4">
                            <div class="summary-card">
                                ...
                                <a href="#"
                                    class="btn bg-blue5 sm-butn text-white hover-darkBlue w-100 mt-3 rounded-pill py-3">
        ...
        <section class="career-form section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form action="mailto:bittupal9920@gmail.com" class="form">
                            <div class="row">
                                <div class="col-lg-6">
