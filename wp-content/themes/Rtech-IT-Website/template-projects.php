                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <div class="info mt-30">
                                    <h5 class="lh-4">
                                        Stay focused and productive with a clean and clutter-free note space. The
                    ...
                    <div class="col-lg-8">
                        <div class="inf">
                            <div class="text color-666 mb-20">
                                Create an unconventional yet user-friendly website – innovative, with a clean & simple
                                design that communicates and showcases multi-media content. Site that spreads the
                                message: "It’s stories your love.”
                            </div>
                            <ul class="color-000">
                                ...
                                <li class="d-flex mb-10">
                                    ...
                                    books, audio stories. <br> Create an experience people want to share with others
                                </li>
                                <li class="d-flex mb-10">
                                    <i class="bi bi-dot fs-6 me-2"></i>
                    ...
                    <div class="col-lg-8">
                        <div class="inf">
                            <div class="text color-666 mb-10">
                                ...
                                features based on events and occasions the brand was focused on. Each quarterly focus
                                would be marked by the hero and custom tags that filter content.
                            </div>
                            <div class="text color-666 mb-20">
                    ...
                    <div class="img-content pt-70 pb-100 border-bottom brd-gray">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="info mt-30">
                                    <h5 class="lh-4">
                                        “The team at <a href="#" class="color-blue5">@iteck</a> is incredibly dedicated,
                                        knowledgeable, and helpful. The finished product was beautiful, and worth every
                                        penny. I would absolutely recommend Moonex Labs.”
                                    </h5>
                                    <a href="#" class="mt-60 color-666 fs-12px text-uppercase">- <strong
                                            class="color-000">Jhon henry </strong> , ceo at notero jsc - </a>
                                    <div class="share mt-100">
                                        <span class="color-999 fs-12px text-uppercase d-block"> share this project
                                        </span>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="project-card style-6">
                                        ...
                                        <div class="info">
                                            <h3 class="title"><a href="page-single-project-5.html">Okpay E-Wallet
                                                    Optimized</a></h3>
